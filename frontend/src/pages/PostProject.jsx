  ...
  return (
    <div className="relative">
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className={`w-full px-4 py-3 border border-gray-300 rounded-lg text-left bg-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 ${
          open ? "ring-2 ring-purple-200 border-purple-500" : ""
        }`}
      >
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="bg-white rounded-lg shadow p-8">
            ...
            <p className="text-gray-600 mb-6">
              You are signed in as a freelancer.
            </p>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
              >
                <option value="less_30">Less than 30 hrs/week</option>
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="mt-2 text-xs text-gray-500">
                Pick the most relevant category. You can refine in filters
                later.
              </p>
            </div>
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="mt-2 text-xs text-gray-500">
                Supported: common docs/images. Larger files may take longer to
                upload.
              </p>
            </div>
          </div>
